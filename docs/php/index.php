...
if (isset($_POST)) {
    $to = 'znatashaa13@gmail.com';
    $subject = 'From portfolio@dropex.net';
    ...
    $message .= '</table>';
    $headers = 'From: portfolio@dropex.net' . PHP_EOL . 'Reply-To: portfolio@dropex.net' . PHP_EOL . 'Content-Type: text/html; charset=UTF-8' . PHP_EOL . 'MIME-Version: 1.0' . PHP_EOL . 'Content-Transfer-Encoding: 8bit ' . PHP_EOL;
